...
function makeQuery(options) {
  ...
  query.setState = function (updater) {
    ...
    exports.globalStateListeners.forEach(function (d) {
      return d();
    });
  };
...
function useIsFetching() {
  ...
  if (!ref.current) {
    ...
    exports.globalStateListeners.push(ref.current);
  }

  React.useEffect(function () {
    return function () {
      exports.globalStateListeners = exports.globalStateListeners.filter(function (d) {
...
exports.refetchAllQueries = refetchAllQueries;
exports.refetchQuery = refetchQuery;
